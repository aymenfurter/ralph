...
export const Icons = {
    ...
    telegram: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>'
};
    ...
    <div class="header idle" id="header">
        <div class="header-content">
            <div class="title">
                ...
                <div class="telegram-pill disabled" id="telegramPill" title="Telegram Bot Status">
                    ${Icons.telegram}
